    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <Link href="/signup" className="inline-flex items-center gap-2 mt-8 px-8 py-3 bg-primary-500 text-white font-medium rounded-lg hover:bg-primary-600 transition-colors text-base">
